var helicopterIMG, helicopterSprite, packageSprite,packageIMG,fenceIMG;
...
function setup() {
	...
	ground = Bodies.rectangle(width/2, 650, 6, 10 , {isStatic:true} );
	 ...
	 g1 = Bodies.rectangle(width/2, 640,100,10, {isStatic:true});
	 World.add(world, g1);

	 g2 = Bodies.rectangle(360,630, 10, 80 , {isStatic:true});
 	World.add(world, g2);
	
	 g3 = Bodies.rectangle(460,630, 10, 80 , {isStatic:true});
 	World.add(world, g3);
